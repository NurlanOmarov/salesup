    ...
    <main>
      ...
      <div className="mt-6">
        <SetupChecklist
          ...
          doneBody="Дальше следите за обучением во вкладках «Работники» и «Отчёты». Понадобится подключить ещё людей — заведите их там же."
        />
      </div>
        ...
        <section className="mt-6 space-y-3">
          {freeSeats > 0 ? (
            <Notice
              ...
              body="Оплаченные места простаивают. Заведите работников и раздайте им логины."
              action={{ href: `${base}/employees`, label: "Завести работников" }}
            />
          ) : null}
