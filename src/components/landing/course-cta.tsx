  ...
  if (checkoutUrl) {
    return (
      <div className="mt-4 space-y-2">
        ...
        {/* Эквайринг белорусский: списание всегда в BYN, а цена выше пересчитана
            по курсу Нацбанка. Банк покупателя конвертирует по своему курсу —
            сумма в его валюте может отойти от показанной, и человек должен знать
            это до оплаты, а не увидеть в выписке. */}
        {payInByn ? (
          <p className="text-center text-xs leading-relaxed text-white/50">
            Оплата в белорусских рублях — {payInByn}. Цена выше пересчитана по курсу
            Нацбанка и указана справочно: ваш банк конвертирует по своему курсу, поэтому
            итоговая сумма может незначительно отличаться.
          </p>
        ) : null}
