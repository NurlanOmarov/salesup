...
export const businessRu = {
  ...
  calculator: {
    ...
    wholeLibrary: "Всю библиотеку",
    separateCourses: "Отдельные курсы",
    pickCourses: "Выберите курсы — посчитаем по ним. Пока считаем по всей библиотеке.",
    libraryCheaper:
      "Выбранные курсы в сумме дороже годового доступа ко всей библиотеке — считаем по библиотеке, она выгоднее.",
