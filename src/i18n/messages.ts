...
const ru = {
  ...
  lead: {
    ...
    contactPhoneHint: "Обязательно с кодом страны — иначе мессенджер не найдёт номер.",
    contactPhoneError: (example: string) =>
      `Такой номер не подходит. Пример правильного: ${example}`,
    telegramError: "Ник не подходит: 5–32 символа, латиница, цифры и «_», первым — буква.",
    emailError: "Адрес не подходит. Пример правильного: ivan@example.com",
    contactEmailHint: "На письма отвечаем дольше: в мессенджере ответим быстрее.",
    telegramUsernameTab: "@username",
    telegramPhoneTab: "по номеру",
    telegramPlaceholder: "username",
    telegramHint: "Ник из настроек Telegram: 5–32 символа, буквы, цифры и «_».",
...
const kk = {
  ...
  lead: {
    ...
    contact: "Сізбен қалай байланысайық? *",
    contactPhoneHint: "Міндетті түрде ел кодымен — әйтпесе мессенджер нөмірді таппайды.",
    contactPhoneError: (example: string) => `Мұндай нөмір жарамайды. Дұрысының мысалы: ${example}`,
    telegramError: "Ник жарамайды: 5–32 таңба, латын әрпі, сан және «_», алдымен әріп.",
    emailError: "Мекенжай жарамайды. Дұрысының мысалы: ivan@example.com",
    contactEmailHint: "Хатқа ұзағырақ жауап береміз: мессенджерде тезірек боламыз.",
    telegramUsernameTab: "@username",
    telegramPhoneTab: "нөмір бойынша",
    telegramPlaceholder: "username",
    telegramHint: "Telegram баптауларындағы ник: 5–32 таңба, әріп, сан және «_».",
    emailPlaceholder: "you@example.com",
    comment: "Пікір",
...
const uz = {
  ...
  lead: {
    ...
    contact: "Siz bilan qanday bog'lanaylik? *",
    contactPhoneHint: "Albatta mamlakat kodi bilan — aks holda messenjer raqamni topmaydi.",
    contactPhoneError: (example: string) => `Bunday raqam to'g'ri kelmaydi. To'g'risiga misol: ${example}`,
    telegramError: "Nik to'g'ri kelmaydi: 5–32 belgi, lotin harflari, raqamlar va «_», birinchi — harf.",
    emailError: "Manzil to'g'ri kelmaydi. To'g'risiga misol: ivan@example.com",
    contactEmailHint: "Xatga uzoqroq javob beramiz: messenjerda tezroq javob beramiz.",
    telegramUsernameTab: "@username",
    telegramPhoneTab: "raqam bo'yicha",
    telegramPlaceholder: "username",
    telegramHint: "Telegram sozlamalaridagi nik: 5–32 belgi, harf, raqam va «_».",
    emailPlaceholder: "you@example.com",
    comment: "Izoh",
