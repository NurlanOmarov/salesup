...
|---|---|---|
| Название | название курса, например «Эффективные продажи кухонь 2.0» | **видно покупателю** на платёжной странице |
| Описание | `Доступ на 12 месяцев откроется на указанный e-mail. Код: sales-kitchens` | **видно покупателю**; код курса здесь обязателен — см. ниже |
...
1. **Кабинет банка → Инструменты оплаты → Ссылки на оплату → Создать.** Заполнить по таблице.
2. Открыть созданную ссылку, нажать **Копировать** — получить адрес вида
   `https://ecom.alfabank.by/sc/XXXXXXXX`.
3. **Админка платформы → Курсы → нужный курс → поле «Ссылка на оплату (Альфа-Банк)»** —
   вставить адрес и сохранить. После этого на карточке курса появляется кнопка «Оплатить и начать».
4. Повторить для всех девяти.
5. Проверить любой курс: открыть его страницу на сайте и убедиться, что цена на кнопке и цена
   на платёжной странице банка совпадают.
...
### 15.4. Что происходит после запуска
