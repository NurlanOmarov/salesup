...
## Внешний аудит витрины — сентябрь 2026 (docs/AUDIT-2026-09.md)

Закрыто в коде: гео-title по доменам, счётчики в HTML (SEO), формулировка про
оплату, состав курса вместо «минут», локальные телефоны стран, корпоративная
академия и апсейлы на /business, движок SEO-посадочных, сбор отзывов перед
сертификатом. Осталось:

**A1 🟥 Наполнение SEO-посадочных.** 4–6 страниц в месяц по очереди кластеров
из `docs/SEO-LANDINGS.md` (возражение «дорого», холодные звонки, продажи в
магазине, туры, B2B и ЛПР, медпредставители, завершение сделки). Каждая — свой
текст от 2500 знаков, FAQ, ссылка на профильный курс.

**A2 🟨 Продуктовая лестница (п. 10 аудита).** Порядок: бесплатный тест
навыков как лид-магнит → бандл 3–5 курсов → PRO (курс + 2 онлайн-разбора).
Подписка CLUB — после, требует рекуррентных платежей. Нужно решение владельца
по составу и ценам уровней.

**A3 🟨 Кейсы платформы (п. 14 аудита).** Автосборка кейса по организации из
уже собираемых данных: прошли/закончили, средний балл до и после, число
тренировок с AI. Публикация — только по реальному пилоту с согласия клиента.

**A4 🟩 Отзывы из соцсетей.** Перенести реальные отзывы со страниц школы в
/admin/reviews (источники Instagram/Facebook/VK/YouTube/Telegram уже есть),
обязательно со ссылкой на первоисточник.
