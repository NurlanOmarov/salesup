...
// остальные ждут, пока фабрика соберёт контент. Бесплатных превью нет —
// доступ к любому уроку только по оплате.
type LessonSpec = { title: string; yt: string; durationSec?: number; publish?: boolean };
...
// ── Курс «B2B продажи промышленной химии» (видео файлами, не с YouTube) ────
...
const COURSES: CourseSpec[] = [
  // ── Курс: Продажи в DIY-магазине (реальный плейлист, контент по видео) ────
  {
    ...
    description:
      "Практический видеокурс бизнес-тренера Виталия Дубовика (activesales.by) для продавцов-консультантов DIY-гипермаркетов и магазинов стройматериалов. 3 урока по реальному тренингу.\n" +
      "\n" +
      "Что разбираем:\n" +
      "— пять этапов продажи: от быстрой консультации до закрытия сделки\n" +
      "— четыре роли продавца: ходящий словарь, шоумен, киллер, партнёр\n" +
      "— три психотипа покупателя (синий-логик, зелёный-социальный, красный-лидер) и своя тактика под каждый\n" +
      "— возражения DIY-розницы: «слишком дорого», «почему нет доставки», «почему нельзя обменять товар сразу», «довезите до кассы» — без единого оправдания, только позитивным конструктивным ответом\n" +
      "\n" +
  ...
  },
  {
    ...
    description:
      "Видеокурс для медицинских представителей, региональных менеджеров и сотрудников фармацевтических компаний. 15 практических уроков, записанных действующим бизнес-тренером по продажам.\n" +
      "\n" +
      "Что разбираем:\n" +
      "— как выявлять потребности врача и работать с конкурентами\n" +
      "— методику СПИН в визите медпредставителя\n" +
      "— убеждение и закрытие сделки\n" +
      "— разбор конфликтных ситуаций\n" +
      "— 3 золотых правила медпреда\n" +
      "\n" +
      "После каждого урока — короткий тест на усвоение материала, а в конце курса — итоговый тест по всем модулям: сдали на проходной балл — получили именной сертификат с проверкой подлинности.",
  ...
  // ── Курс: СПИН-продажи (реальный плейлист, контент по видео) ──────────────
  {
    ...
    description:
      "Практический видеокурс по методу СПИН от бизнес-тренера Виталия Дубовика (activesales.by). Большинство продавцов умеют выявлять потребность открытыми вопросами, но почти никто не умеет её формировать — а именно это отличает консультанта от продавца. Семь уроков.\n" +
      "\n" +
      "Что внутри:\n" +
      "— четыре вида вопросов: ситуационные, проблемные, извлекающие, направляющие\n" +
      "— схема презентации «факт → выгода → согласие»\n" +
      "— готовые наборы вопросов под шесть сфер: строительный супермаркет и DIY, салон часов, поставка оборудования в B2B, банк и лизинг, продажа экспертных услуг и даже разговор с ребёнком об учёбе\n" +
      "\n" +
      "После каждого урока — короткий тест на усвоение материала, а в конце курса — итоговый тест по всем модулям: сдали на проходной балл — получили именной сертификат с проверкой подлинности.",
  ...
  // ── Курс: Тайм-менеджмент (реальные видео, контент собирается фабрикой) ────
  {
    ...
    description:
      "Практический видеокурс по тайм-менеджменту от бизнес-тренера Виталия Дубовика (activesales.by). 18 уроков — от базовых принципов до готовых инструментов. Материал снят на живых тренингах в B2B, но все модели универсальны.\n" +
      "\n" +
      "Что разбираем:\n" +
      "— приоритеты по матрице Эйзенхауэра и планирование дня по правилу 60/40\n" +
      "— «лягушку» с утра, техники «слон» и «три гвоздя» для крупных задач\n" +
      "— постановку целей, ежедневник и Google Календарь\n" +
      "— поиск «пожирателей времени» через хронометраж\n" +
      "— продуктивную работу в офисе и удалённо\n" +
      "\n" +
      "После каждого урока — короткий тест на усвоение материала, а в конце курса — итоговый тест по всем модулям: сдали на проходной балл — получили именной сертификат с проверкой подлинности.",
  ...
  // ── Курс «Техники продаж в туризме» (реальный плейлист) ───────────────────
  {
    ...
    description:
      "Практический видеокурс бизнес-тренера Виталия Дубовика (activesales.by) для менеджеров турагентств и туроператоров. 13 уроков по реальному тренингу.\n" +
      "\n" +
      "Что разбираем:\n" +
      "— из чего складывается решение туриста: продукт, компания и продавец (на продавца приходится до 87 % влияния)\n" +
      "— четыре роли продавца и цикл сделки глазами туриста\n" +
      "— типичные ошибки и зоны опасности\n" +
      "— алгоритм входящего звонка из девяти шагов\n" +
      "— воронку вопросов: открытые → альтернативные → закрытые\n" +
      "— четыре типа туристов и подстройку под каждый\n" +
      "— готовые ответы на «дорого», «я просто изучаю» и «я подумаю»\n" +
      "— работу с конфликтом, пять способов закрыть сделку и возврат туриста после поездки\n" +
      "\n" +
      "После каждого урока — короткий тест на усвоение материала, а в конце курса — итоговый тест по всем модулям: сдали на проходной балл — получили именной сертификат с проверкой подлинности.",
    industry: "Туризм",
  ...
  // ── Курс «Техники продаж недвижимости» (реальный плейлист) ────────────────
  {
    ...
    description:
      "Практический видеокурс бизнес-тренера Виталия Дубовика (activesales.by) для риэлторов, агентов и руководителей агентств недвижимости. 9 уроков про частные продажи физлицам.\n" +
      "\n" +
      "Что разбираем:\n" +
      "— чем продажа квартиры отличается от любых других продаж и в чём ценность услуги риэлтора\n" +
      "— что на самом деле происходит в голове у продавца квартиры: айсберг из восьми родственников, тёщи и СМИ\n" +
      "— тактику трёх шагов, после которой клиент сам говорит о снижении цены\n" +
      "— шесть типичных ошибок: лень и скорость реакции, попытка «слить» квартиру ниже рынка, манипуляции с семьёй и эксклюзивом, поверхностно выясненные потребности, неумение работать с возражениями и потеря репутации на конфликте\n" +
      "\n" +
      "После каждого урока — короткий тест на усвоение материала, а в конце курса — итоговый тест по всем модулям: сдали на проходной балл — получили именной сертификат с проверкой подлинности.",
  ...
  },
  {
    ...
    description:
      "Большой видеокурс бизнес-тренера Виталия Дубовика (activesales.by) для дизайнеров и продавцов кухонной мебели: 33 урока и почти шесть часов практики.\n" +
      "\n" +
      "Что внутри:\n" +
      "— как устроен рынок кухонь, кто на нём играет и какие источники лидов работают\n" +
      "— что можно и чего нельзя делать в салоне\n" +
      "— переписка в мессенджерах и звонки по готовым скриптам\n" +
      "— чек-лист дизайнера и 7 советов для заключения договора\n" +
      "— психология покупателя по типам, 13 типичных ошибок и 10 золотых правил\n" +
  ...
  },
  {
    ...
    industry: "Ломбарды",
    hoursLabel: "~54 минуты",
    // Час видео — рекомендованная цена экспресс-ступени, как у остальных
    // отраслевых курсов того же объёма (DIY, медпреды, обувь).
    priceTiyn: 35000,
    learnPoints: [
  ...
  },
  {
    ...
    title: "B2B продажи промышленной химии",
  ...
  },
  {
    ...
    industry: "Мебель и кухни",
    hoursLabel: "~9 минут",
    // Экспресс-коридор отраслевого курса — 290–420 BYN. Девять минут — самый
    // маленький объём в линейке, поэтому берём нижнюю границу коридора.
    priceTiyn: 29000,
    learnPoints: [
  ...
  },
  {
    ...
    subtitle: "Семь этапов продажи в торговом зале: от контакта до расширения чека",
    description:
      "Практический видеокурс для продавцов-консультантов обувных и одёжных салонов от бизнес-тренера Виталия Дубовика (activesales.by). Пять уроков — весь цикл работы с покупателем в торговом зале.\n" +
      "\n" +
      "Что разбираем:\n" +
      "— как позиционироваться в зале и поймать момент для подхода\n" +
      "— какими вопросами выявлять потребность\n" +
      "— как презентовать на языке выгод и по какому правилу предлагать покупателю сразу три варианта\n" +
      "— как отвечать на «дорого», «я просто смотрю», «боюсь неизвестный бренд» и «я подумаю»\n" +
      "— как расширять чек второй парой или вещью в комплект, аксессуарами и средствами ухода\n" +
      "— восемь способов завершить продажу\n" +
      "— 13 типичных ошибок продавца, из-за которых покупатель уходит без покупки\n" +
      "\n" +
      "После каждого урока — короткий тест на усвоение материала, а в конце курса — итоговый тест по всем модулям: сдали на проходной балл — получили именной сертификат с проверкой подлинности.",
    ...
    learnPoints: [
      ...
      "Делать презентацию по технике «свойство → выгода», правилу трёх вариантов (три коробки обуви или три вещи на примерку) и правилу Гомера",
      "Отвечать на четыре типичных возражения покупателя в салоне: «дорого», «я просто смотрю», «боюсь неизвестный бренд», «я подумаю»",
      "Расширять чек: вторая пара или вещь в комплект, аксессуары и средства ухода — cross-sell, up-sell и down-sell",
      "Завершать сделку восемью способами — от прямого и альтернативного до «короны» покупателю",
      "Не допускать 13 типичных ошибок продавца — от оценки клиента по внешнему виду до «Спасибо, пожалуйста»",
    ],
    targetAudience: [
  ...
  },
  {
    ...
    description:
      "Живой тренинг и системный курс бизнес-тренера Виталия Дубовика по деловым переговорам и продажам в B2B: 28 уроков в семи модулях.\n" +
      "\n" +
      "Что внутри:\n" +
      "— проактивная подготовка вместо реакции на рынок\n" +
      "— карта ролей в компании клиента (ЛПР, ЛВР, ЛДПР) и математика воронки\n" +
      "— четыре типа переговоров — «железо, бронза, серебро, золото» — и 11 тактик манипуляции\n" +
      "— VIP-переговоры и методика СПИН\n" +
      "— система B2B-продаж: сегментация лидов, путь клиента и конверсия этапов, удержание, сильное коммерческое предложение, фиксация договорённостей\n" +
      "— цена и премиальный сегмент: пирамида потребностей партнёра, продажа сложного и дорогого продукта, холодные звонки, конфликты, GAPP-анализ\n" +
      "— работа в полях: ошибки торгового представителя и вход в сеть\n" +
      "\n" +
      "После каждого урока — короткий тест на усвоение материала, а в конце курса — итоговый тест по всем модулям: сдали на проходной балл — получили именной сертификат с проверкой подлинности.",
      ...
      for (const [lIdx, l] of m.lessons.entries()) {
        await db.lesson.create({
          data: {
            ...
            title: l.title,
            sortOrder: lIdx,
            status: l.publish ? "PUBLISHED" : "DRAFT",
            youtubeUrl: l.yt,
      ...
      for (const [lIdx, l] of m.lessons.entries()) {
        await db.lesson.create({
          data: {
            ...
            title: l.title,
            sortOrder: lIdx,
            // Вводный урок публикуем сразу; остальные остаются DRAFT, пока
            // фабрика не соберёт контент.
            status: l.publish ? "PUBLISHED" : "DRAFT",
            youtubeUrl: l.yt,
            durationSec: l.durationSec ?? null,
            videoStatus: "NONE",
...
async function main() {
  ...
  // ── Курс «B2B продажи промышленной химии» ───────────────────────────────
